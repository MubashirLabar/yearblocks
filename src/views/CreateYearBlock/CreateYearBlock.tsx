  ...
  return (
    <Layout>
      <div className="w-full flex justify-center">
        <div className="w-full max-w-[600px] margins flex flex-col py-12 sm:py-16 lg:py-24">
          ...
          <div className="text-sm sm:text-base lg:text-[22px] leading-6 sm:leading-[28px] lg:leading-[36px] text-service-700 text-center mb-8 xl:mb-12">
            Upload and mint a new YearBlocks here
          </div>
          ...
          <div className="w-full flex flex-col gap-y-6 sm:gap-y-10">
